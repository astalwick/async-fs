...
exports.FileEventEmitter  = FileEventEmitter;
...
exports.watchTree = function watchTree_asyncFs(dir_path) {
  ...
  console.log('watchtree', dir_path)
  
  var files = fs.readdirSync(dir_path);

  console.log('watchtree', dir_path, files.length)
      ...
      , function iterator(filename, callback) {
          ...
          var stats = fs.statSync(file_path);
            ...
            emitter.on('change', function(curr, prev) {
              ...
              dir_event_emitter.emit('change', curr, prev);
...
exports.forEachFile = function forEachFile(path, iterator, callback) {
  ...
  console.log('foreachFile readdir')
  var files = fs.readdirSync(path);
  console.log('foreachFile readdir done', files.length)
...
exports.forEachFileSeries = function forEachFileSeries(path, iterator, callback) {
  ...
  console.log('foreachFileSeries readdir')
  var files = fs.readdirSync(path);
  console.log('foreachFileSeries readdir done', files.length)
  async.forEachSeries(files, iterator, callback);  
}
...
exports.mapDir = function mapDir() {
  ...
  var args = Array.prototype.slice.call(arguments)
    ...
    var emitter   = new FileEventEmitter(dir_path)
    , snapshot
    ;
  ...
  async.waterfall(
      ...
      , function (files, callback) {
        ...
        console.log('READ ALL OF ', dir_path, ' files:', files.length);
